...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not user:
        await update.message.reply_text(
            """
Для игроков:
Это ТГ бот для игры Shift, к нему прикручен ИИ, умеет продавать и покупать игровую информацию. Пожалуйста, не пытайтесь его сломать "по жизни", в случае возникновения технических проблем - напишите Басу. Он полностью игровой, общайтесь с ним как человеком (в реальности игры он "отыгрывает" персонажа).
❗️Убедительная просьба - ни в коем случае не пытайтесь продать ему информацию, которая не относится к нашей ролевой игре: "пожизнёвую", с других игр, из книг и так далее. Нарушение этого правила карается МГ.

Для персонажей:
Привет, меня зовут Меняла и у меня есть для вас разная интересная информация, разбитая на категории. Вы можете купить её, предварительно продав мне другую полезную/важную информацию. Вся проданная информация попадает в общий доступ и может быть куплена другими желающими. Валюта может называться по разному, суть всегда одна - мне просто так веселее :)
Иногда я буду сверять информацию, которую вы мне продали, по своим каналам и если она окажется ложью - ждите проблем, "прокляну" до третьего колено (а ведь изначально у вас их было 2!), я пердупредил!
